# @gennadysx/react-native-background-geolocation

[![npm](https://img.shields.io/npm/v/@gennadysx/react-native-background-geolocation?style=flat-square)](https://www.npmjs.com/package/@gennadysx/react-native-background-geolocation)
...
```
yarn add @gennadysx/react-native-background-geolocation
```
...
```
node ./node_modules/@gennadysx/react-native-background-geolocation/scripts/postlink.js
```
...
```gradle
...
include ':@gennadysx_react-native-background-geolocation-common'
project(':@gennadysx_react-native-background-geolocation-common').projectDir = new File(rootProject.projectDir, '../node_modules/@gennadysx/react-native-background-geolocation/android/common')
include ':@gennadysx_react-native-background-geolocation'
project(':@gennadysx_react-native-background-geolocation').projectDir = new File(rootProject.projectDir, '../node_modules/@gennadysx/react-native-background-geolocation/android/lib')
...
```
...
dependencies {
    ...
    compile project(':@gennadysx_react-native-background-geolocation')
    ...
}
```
...
2. Add `./node_modules/@gennadysx/react-native-background-geolocation/ios/RCTBackgroundGeolocation.xcodeproj`
...
import BackgroundGeolocation from '@gennadysx/react-native-background-geolocation';
